...
class UpgradeToFullMembershipIT extends GebSpec {
    ...
    def "guest member verification flow when guest has no docs"() {
        ...
        and: "member receives email saying they are now a full member"
            ...
            getEmails(GUEST_EMAIL_ADDRESS, "Inbox")[0].content.contains("Dear John Smith, You have now been upgraded to full membership. You should now have full access to the LCAG members forum: https://forum.hmrcloancharge.info Your forum username is: newguest If you can’t remember your forum account details, please use the forgotten password facility and a new password will be sent to you: https://forum.hmrcloancharge.info/member.php?action=lostpw For information about the forthcoming mis-selling legal action, please visit the Mis-selling Legal Action forum area: https://forum.hmrcloancharge.info/showthread.php?tid=191 In order to register for the forthcoming mis-selling legal action, please complete the Claim Participant Form: https://claim.hmrcloancharge.info?token=bbbbbbbbbbbbbbbbbbbb Thank you, Richard Horsley Membership Team")
