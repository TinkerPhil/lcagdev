...
class BankTransactionAssignmentIT extends GebSpec {
    ...
    def "manual bank transaction assignment triggers payment receipt email"() {
        ...
        and: "new member receives email saying their payment has been received"
            ...
            getEmails(MEMBER_EMAIL_ADDRESS, "Inbox")[0].content.contains("Dear John Smith, Your subscription of £50 has now been received. If you are a newly joined full member, you will be upgraded to full membership as soon as we have reconciled the payment. Note there can be a lag of 1-2 days before this occurs so please be patient. Please remember that you may not be made upgraded until you have provided Photo ID and proof of Loan Scheme usage. If you are an existing member making an additional donation, we THANK YOU for it. Thank you, LCAG Membership Team")
