...
public class MemberMpCampaignController {
    ...
    public ResponseEntity update(
            ...
            @RequestParam(value = "userNotes", required = false) String userNotes,
            @RequestParam(value = "userTelNo", required = false) String userTelNo,
            @RequestParam(value = "userTags", required = false) String userTags,
